...
function registerAccount(){
	location.href = "q_detail.do?id=1";
}
//修改密码
function resetPassword(){
	location.href = "q_detail.do?id=2";
}
//忘记登录密码
function forgetPassword(){
	location.href = "q_detail.do?id=3";
}
//修改手机号
function resetPhone(){
	location.href = "q_detail.do?id=4";
}
//收不到手机验证码
function phoneCode(){
	location.href = "q_detail.do?id=5";
}
//使用手机号码注册不了新账户
function registerNewUser(){
	location.href = "q_detail.do?id=6";
}
//注册失败
function registerError(){
	location.href = "q_detail.do?id=7";
}
...
function goodsAuthentic(){
	location.href = "q_detail.do?id=8";
}
//为什么价格很便宜
function cheapPrice(){
	location.href = "q_detail.do?id=9";
}
//商品材质/资料
function goodsMaterial(){
	location.href = "q_detail.do?id=10";
}
//为什么价格不一样
function priceDifferent(){
	location.href = "q_detail.do?id=11";
}
//限时抢购的商品如何设置开售提醒
function snappingGoods(){
	location.href = "q_detail.do?id=12";
}
//为什么商品上线没多久就售完了
function goodsSales(){
	location.href = "q_detail.do?id=13";
}
...
//如何下单购买
function shopping(){
	location.href = "q_detail.do?id=14";
}
//修改订单收货地址、电话
function resetOrderAccount(){
	location.href = "q_detail.do?id=15";
}
//购物车无商品
function shoppingCar(){
	location.href = "q_detail.do?id=16";
}
//多长时间收货
function receiving(){
	location.href = "q_detail.do?id=17";
}
//如何查询订单
function selectOrder(){
	location.href = "q_detail.do?id=18";
}
//如何查询优惠券
function selectCoupon(){
	location.href = "q_detail.do?id=19";
}
//如何使用优惠券
function useCoupon(){
	location.href = "q_detail.do?id=20";
}
...
//如何支付
function pay(){
	location.href = "q_detail.do?id=21";
}
//支持哪些支付方式
function payType(){
	location.href = "q_detail.do?id=22";
}
//支付不成功订单重新支付
function againPay(){
	location.href = "q_detail.do?id=23";
}
//运费说明
function freightCharges(){
	location.href = "q_detail.do?id=24";
}
...
//如何签收与拒收商品
function sign(){
	location.href = "q_detail.do?id=25";
}
//如果办理退换货
function returnGoods(){
	location.href = "q_detail.do?id=26";
}
//可以开箱验货吗
function inspection(){
	location.href = "q_detail.do?id=27";
}
//包裹错发/漏发
function wrongHair(){
	location.href = "q_detail.do?id=28";
}
//偏远地区能否送到
function remoteAreas(){
	location.href = "q_detail.do?id=29";
}
//没收到商品但是订单显示签收了
function notReceived(){
	location.href = "q_detail.do?id=30";
}
//退货后，什么时候退款
function refundDate(){
	location.href = "q_detail.do?id=31";
}
//退款到哪里
function refundWhere(){
	location.href = "q_detail.do?id=32";
}
//退货能上门取件吗
function pickUp(){
	location.href = "q_detail.do?id=33";
}
//没有收到赠品怎么办
function premiums(){
	location.href = "q_detail.do?id=34";
}
//投诉、建议
function complaints(){
	location.href = "q_detail.do?id=35";
}
...
function cancelOrder(){
	location.href = "q_detail.do?id=36";
}
